    ...
    return Scaffold(
        ...
        body: Column(
            ...
            children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              CustomDetailRow(
                                  ...
                                  value:
                                      viewModel.fetchDateFromString(model.dob)),
                              CustomDetailRow(
                                  propertyName: "Date of issue: ",
                                  value:
                                      viewModel.fetchDateFromString(model.doi)),
                              CustomDetailRow(
                                  propertyName: "Date of expiry: ",
                                  value:
                                      viewModel.fetchDateFromString(model.doe)),
                              const SizedBox(height: 20)
                            ],
                          ),
                        )
              ...
              InkWell(
                  onTap: () async {
                    viewModel.setDataFromResponse(viewModel.json);
                    // ImagePicker picker = ImagePicker();
                    // XFile? xfile =
                    //     await picker.pickImage(source: ImageSource.camera);
                    // if (xfile != null) {
                    //   viewModel.processDeviceImage(xfile);
                    // }
                  },
                  child:
